...
async def on_message(message):
    ...
    if cmd_text == 'maud' and message.author.id in [763756054197698590, 437922808161501184, 486839789933559808, 273204171002609664, 671749428163510283, 837349606861307924, 852032172482363433, 721742395657551993]: # [abu, sawmill, manu, naahsi, loli, manu_endra, naahsi_alt, ani]
        local_botrole = 0
